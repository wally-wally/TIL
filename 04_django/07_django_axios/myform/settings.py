...
AUTHENTICATION_BACKENDS = (
    ...
    # 'allauth.account.auth_backends.AuthenticationBackend', (django 2.2 버전 이후로는 안 먹힘)
...
# LOGIN_REDIRECT_URL = '/accounts/profile/' # 이게 기본값으로 숨겨져 있어서 처음에 카카오 로그인하면 Page Not Found 오류가 떴음